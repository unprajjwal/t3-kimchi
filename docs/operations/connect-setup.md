...
T3CODE_PORT=13773 \
  "/Applications/T3 Kimchi.app/Contents/MacOS/T3 Kimchi"
```
...
```sh
codesign --verify --deep --strict "/Applications/T3 Kimchi.app"
codesign -d --entitlements :- "/Applications/T3 Kimchi.app"
```
